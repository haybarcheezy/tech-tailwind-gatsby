        ...
        <div className="flex flex-wrap -m-4">
          <div className="xl:w-1/2 md:w-1/2 p-4">
            <div className="border border-gray-300 p-6 rounded-lg text-center shadow-lg bg-white">
              ...
              <Icon icon={cloudDownloadOutlined} style={{fontSize: '100px'}} className="p-2 bg-white text-blue-400" />
              </div>
              ...
              <Link to="/" className="bg-white hover:bg-gray-100 text-gray-800 font-medium text-sm py-2 px-4 border border-gray-400 rounded">Learn More</Link>
              </div>
            </div>
          </div>
          <div className="xl:w-1/2 md:w-1/2 p-4">
            <div className="border border-gray-300 p-6 rounded-lg text-center shadow-lg bg-white">
              <div className="inline-flex items-center justify-center rounded-full mb-4">
              <Icon icon={deploymentUnitOutlined} style={{fontSize: '100px'}} className="p-2 bg-white text-blue-400" />
              </div>
              <h2 className="text-lg text-gray-900 font-medium title-font mb-2">
                The Catalyzer
              </h2>
          ...
          <div className="xl:w-1/2 md:w-1/2 p-4">
            <div className="border border-gray-300 p-6 rounded-lg text-center shadow-lg bg-white">
              <div className="inline-flex items-center justify-center rounded-full mb-4">
              <Icon icon={hddOutlined} style={{fontSize: '100px'}} className="p-2 bg-white text-blue-400" />
              </div>
              <h2 className="text-lg text-gray-900 font-medium title-font mb-2">
                Melanchole
              </h2>
          ...
          <div className="xl:w-1/2 md:w-1/2 p-4">
            <div className="border border-gray-300 p-6 rounded-lg text-center shadow-lg bg-white">
              <div className="inline-flex items-center justify-center rounded-full mb-4">
              <Icon icon={securityScanOutlined} style={{fontSize: '100px'}} className="p-2 bg-white text-blue-400" />
          ...
          <div className="xl:w-1/2 md:w-1/2 p-4">
            <div className="border border-gray-300 p-6 rounded-lg text-center shadow-lg bg-white">
              <div className="inline-flex items-center justify-center rounded-full mb-4">
              <Icon icon={syncOutlined} style={{fontSize: '100px'}} className="p-2 bg-white text-blue-400"/>
              </div>
              <h2 className="text-lg text-gray-900 font-medium title-font mb-2">
                Melanchole
              </h2>
          ...
          <div className="xl:w-1/2 md:w-1/2 p-4">
            <div className="border border-gray-300 p-6 rounded-lg text-center shadow-lg bg-white">
              <div className="inline-flex items-center justify-center rounded-full mb-4">
              <Icon icon={codeOutlined} style={{fontSize: '100px'}} className="p-2 bg-white text-blue-400" />
              </div>
              <h2 className="text-lg text-gray-900 font-medium title-font mb-2">
                Bunker
              </h2>

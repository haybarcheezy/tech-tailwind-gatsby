            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap">
                    <div className="w-full lg:w-6/12 px-4">
                        ...
                        <div className="mt-6">
                        <a href="https://facebook.com/" className="p-2 bg-white shadow-lg items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 inline-block text-center"><Icon icon={facebookFilled} style={{color: '#3b5998', fontSize: '24px'}} /></a>
                            <a href="https://linkedin.com/" className="p-2 bg-white shadow-lg items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 inline-block text-center"><Icon icon={linkedinFilled} style={{ color: '#0E76A8', fontSize: '24px'}} /></a>
                            <a href="https://github.com/" className="p-2 bg-white shadow-lg items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 inline-block text-center"><Icon icon={githubFilled} style={{color: '#24292e', fontSize: '24px'}} /></a>
                        </div>
